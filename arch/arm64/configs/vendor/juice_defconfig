CONFIG_LOCALVERSION="-Juice-Bengal"
...
CONFIG_CMDLINE="mitigations=off quiet audit=0 cgroup_disable=pressure"
...
CONFIG_ANDROID_SIMPLE_LMK_MINFREE=96
CONFIG_ANDROID_SIMPLE_LMK_TIMEOUT_MSEC=150
